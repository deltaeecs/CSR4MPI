...
public:
    ...
    static void ExportLocalBlock(const cCSRMatrix<Scalar>& cLocal,
        ...
        std::vector<Scalar>& vA)
    {
        ...
        const std::vector<Scalar>& vValues = cLocal.vValues();
    ...
    static iSize ExportLocalBlockInto(const cCSRMatrix<Scalar>& cLocal,
        const cRowDistribution& cDistribution,
        int* pIRN,
        int* pJCN,
        Scalar* pA)
...
using cMumpsAdapterF = cMumpsAdapter<float>;
using cMumpsAdapterD = cMumpsAdapter<double>;
using cMumpsAdapterCF = cMumpsAdapter<std::complex<float>>;
using cMumpsAdapterCD = cMumpsAdapter<std::complex<double>>;
